									...
									<p style="text-align: right;">Pershendetje, <em><?php echo $useri;?>!</em></p> 
										...
										<div class="col-6 col-12-medium">
														...
														while($rreshti = mysqli_fetch_array($sql)) { 		
																...
																echo "<td><a href=\"fshi.php?ID_Perdoruesi=$rreshti[ID_Perdoruesi]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\" class='button' class='button primary'>Fshijë</a>
																</td></tr>";		
															}
														}
														?>
